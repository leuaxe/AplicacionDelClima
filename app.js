...
let velocidadViento = document.getElementById("velocidadViendo");
let encabezaCiudad = document.getElementById("encabezadoCiudad");
...
encabezaCiudad.innerHTML = resultFromServer.name;
